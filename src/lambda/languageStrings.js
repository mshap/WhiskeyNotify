...
module.exports = {
    en: {
        translation: {
            ...
            NO_LOCATION_MSG: 'You have not set your home store yet. Tell me \'Search from StoreId\' to set one.',
            NO_STOCK_MSG: 'There are no bottles in stock, sorry.',
            IN_STOCK_MSG: 'I found {{bottles}} in stock at {{stores}} stores.',
            STORES_MSG: '{{name}} ({{description}}) at {{address}} has {{quantity}} bottles. Call them at {{phone}}.',
            SEARCH_PROMPT: 'Would you like to search for a product? Ask \'find ProductCode\'.',
            STORE_PROMPT: 'Would you like to know which stores have this item in stock? Ask \'Which stores\'.',
